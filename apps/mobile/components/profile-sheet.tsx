...
export function ProfileSheet({ open, onOpenChange }: ProfileSheetProps) {
  ...
  async function handleSignOut() {
    ...
    try {
      ...
      // (Nothing persists to disk anymore — cache persistence was removed; see
      // lib/api/query-client.ts. The root layout's onSignedOut does the same on
      // every sign-out path; doing it here too guarantees the scrub lands
      // BEFORE the signOut round-trip.)
      lockJournal();
      queryClient.clear();
