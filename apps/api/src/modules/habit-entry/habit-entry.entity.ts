...
export class HabitEntry extends Entity<HabitEntryProps> {
  private constructor(props: HabitEntryProps, id?: string) {
    super(props, id);
  }
  ...
  static reconstitute(props: HabitEntryProps, id: string): HabitEntry {
    return new HabitEntry(props, id);
  }
}
