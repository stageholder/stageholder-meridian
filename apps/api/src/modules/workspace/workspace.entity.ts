import { Entity, EntityProps, Ok, Err, Result, generateShortId } from '../../shared';
...
export class Workspace extends Entity<WorkspaceProps> {
  ...
  static create(props: Omit<WorkspaceProps, 'id' | 'createdAt' | 'updatedAt' | 'shortId'>): Result<Workspace> {
