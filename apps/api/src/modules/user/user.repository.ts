    ...
    return User.reconstitute(
      {
        ...
        encryptedDek: doc.encrypted_dek,
        dekSalt: doc.dek_salt,
        recoveryCodesHash: doc.recovery_codes_hash,
        encryptionEnabled: doc.encryption_enabled ?? false,
