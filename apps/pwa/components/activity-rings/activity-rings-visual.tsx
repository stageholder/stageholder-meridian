...
const SIZE_CONFIG: Record<
  ActivityRingsSize,
  { px: number; stroke: number; gap: number }
> = {
  ...
  return [
    {
      ...
      trackColor: RING_COLORS.journal.track,
      percent: data.journal,
      delay: 300,
      type: "journal" as RingType,
    },
    {
      radius: middleR,
      color: RING_COLORS.habit.color,
      trackColor: RING_COLORS.habit.track,
      percent: data.habit,
      delay: 150,
      type: "habit" as RingType,
    },
    {
      radius: innerR,
      color: RING_COLORS.todo.color,
      trackColor: RING_COLORS.todo.track,
      percent: data.todo,
      delay: 0,
      type: "todo" as RingType,
    },
  ];
}
...
export function ActivityRingsVisual({
  data,
  size = "md",
  animate = true,
  star,
  className,
}: ActivityRingsVisualProps) {
